...
{
    public class UpdateListReturnBoleanComplianceDistributorsDataCommandHandler : IRequestHandler<UpdateListReturnBoleanComplianceDistributorsDataListCommand, ApiResponse<Boolean>>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;

        public UpdateListReturnBoleanComplianceDistributorsDataCommandHandler(IUnitOfWork unitOfWork, IMapper mapper)
        {
            _unitOfWork = unitOfWork;
            _mapper = mapper;
        }

        public async Task<ApiResponse<bool>> Handle(UpdateListReturnBoleanComplianceDistributorsDataListCommand request, CancellationToken cancellationToken)
        {
        ...
        public async Task<ApiResponse<IReadOnlyList<ComplianceDistributorData>>> Validate(UpdateListReturnBoleanComplianceDistributorsDataListCommand request)
        {
            Boolean success = false;
